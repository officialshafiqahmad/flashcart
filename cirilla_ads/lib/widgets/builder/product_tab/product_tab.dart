            ...
            child: TabBar(
              ...
              tabs: List.generate(
                ...
                (inx) {
                  ...
                  String name = ConvertData.textFromConfigs(get(item, ['data', 'name']), languageKey);
                  return Container(
...
class _ProductListWidgetState extends State<ProductListWidget> with Utility, PostMixin {
  ...
  void didChangeDependencies() {
    ...
    bool enableGeoSearch = ConvertData.toBoolValue(get(widget.fields, ['enableGeoSearch'])) ?? true;
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) {
        ...
        // Styles config
        double height = ConvertData.stringToDouble(get(widget.styles, ['height'], 300));
