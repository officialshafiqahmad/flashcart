    ...
    switch (type) {
      case 'product':
        ...
        Widget priceWidget = Wrap(
          ...
          children: [
            Text(
              ...
              style: theme.textTheme.titleSmall?.copyWith(color: ColorBlock.red),
            ),
            Padding(
        ...
        children.add(
          WoocommerceBoxProductItem(
            ...
            price: priceWidget,
            description: Text(description.replaceAll(RegExp(r"\s+\b|\b\s"), " "), style: theme.textTheme.bodySmall),
            button: SizedBox(
              height: 34,
            ...
            band: Row(
              children: [
                Expanded(child: Text(brandList, style: theme.textTheme.bodySmall)),
                const InkWell(
      ...
      case 'specifiction':
        ...
        if (productAttributes is String && productAttributes.isNotEmpty) {
          double fontSize = theme.textTheme.bodyMedium?.fontSize ?? 14;
          ...
          children.add(ClipRRect(
            ...
            child: Html(
              ...
              style: {
                ...
                'body': styleTag,
                'p': styleTag.copyWith(margin: Margins(left: Margin(secondItemPaddingSmall))),
                'div': styleTag,
                // 'img': styleTag,
                'table': Style(
                  padding: HtmlPaddings.all(itemPaddingMedium),
                ),
                'th': Style(
