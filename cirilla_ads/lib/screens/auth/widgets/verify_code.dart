        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: _start == widget.timeStart
                    ? () {
                        startTimer();
                        widget.onReSend!();
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: _currentText.length < widget.lengthVerify ? null : () => widget.onVerify!(_currentText),
