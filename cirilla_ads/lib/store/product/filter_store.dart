...
abstract class FilterStoreBase with Store {
  ...
  FilterStoreBase(
    ...
    if (rangePricesSelected != null) _rangePricesSelected = rangePricesSelected;
    if (productPricesSelected != null) _productPricesSelected = productPricesSelected;
  ...
  @observable
  ProductPrices _productPricesSelected = ProductPrices(minPrice: 0.0, maxPrice: 0.0);

  @observable
  RangeValues _rangePricesSelected = const RangeValues(0.0, 0.0);
  ...
  @computed
  RangeValues get rangePricesSelected => _rangePricesSelected;

  @computed
  ProductPrices get productPricesSelected => _productPricesSelected;
  ...
  void setMinMaxPrice(double minPrice, double maxPrice) {
    _rangePricesSelected = RangeValues(minPrice, maxPrice);
  }
  ...
  void onChange({
    ...
    if (rangePricesSelected != null) {
      _rangePricesSelected = RangeValues(
        rangePricesSelected.start,
        rangePricesSelected.end,
      );
    }
    if (productPricesSelected != null) {
      _productPricesSelected = ProductPrices(
        minPrice: productPricesSelected.minPrice,
        maxPrice: productPricesSelected.maxPrice,
      );
    }
  ...
  void clearAll({List<ProductCategory>? categories, Brand? brand}) {
    ...
    _rangePricesSelected = const RangeValues(0.0, 0.0);
    _productPricesSelected = ProductPrices(minPrice: 0, maxPrice: 0);
