...
abstract class ProductsStoreBase with Store {
  ...
  @observable
  Map<String, dynamic> _sort = defaultSorting;
  ...
  Future<List<Product>> getProducts({CancelToken? token, Map<String, dynamic>? customQuery}) async {
    ...
    Map<String, dynamic> query = {
      ...
      "tag": _tag.join(','),
      "vendor": _vendor?.id,
      "min_price": _filterStore!.rangePricesSelected.start > 0 ? _filterStore!.rangePricesSelected.start : null,
      "max_price": _filterStore!.rangePricesSelected.end > 0 ? _filterStore!.rangePricesSelected.end : null,
  ...
  void onChanged({
    ...
    if (filterStore != null) {
      _filterStore!.onChange(
        ...
        rangePricesSelected: filterStore.rangePricesSelected,
        productPricesSelected: filterStore.productPricesSelected,
      );
    }
  }
